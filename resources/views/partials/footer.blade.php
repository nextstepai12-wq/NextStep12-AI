    ...
    <div class="footer-top">
      ...
      <div class="footer-col footer-brand">
        <div class="brand-mark">
          <img src="{{ asset('NextStepAi-front/assets/logo.png') }}" alt="NextStep AI" class="brand-logo">
      ...
      <div class="footer-col">
        <h4>روابط الموقع</h4>
        <ul>
          <li><a href="{{ route('home') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/></svg>الرئيسية</a></li>
          <li><a href="{{ route('pages.quiz') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M8 2v4M16 2v4M3 10h18"/></svg>اختبار الاستكشاف</a></li>
          <li><a href="{{ route('pages.results') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20V10M12 20V4M20 20v-7"/></svg>النتائج</a></li>
          <li><a href="{{ route('pages.study-plan') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>الخطة الدراسية</a></li>
          <li><a href="#"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M5 21V7l7-4 7 4v14M9 9h1M14 9h1M9 13h1M14 13h1M9 17h1M14 17h1"/></svg>الجامعات</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col">
        ...
        <div class="contact-item">
          ...
          <a href="mailto:info@nextstepai.com">info@nextstepai.com</a>
        </div>
        <div class="contact-item">
          ...
          <a href="tel:+970000000">+970 00 000 0000</a>
        </div>
        <div class="contact-item">
